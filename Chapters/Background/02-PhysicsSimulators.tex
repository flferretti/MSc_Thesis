...
\CarlottaSays{Maybe you can say in the introduction of this chapter, that since jax will be used you will give more details about the implementation e.g. first review of simulator and then the basic guide to jax. Long story short: better describe in the chapter introduction the chapter organization.}
