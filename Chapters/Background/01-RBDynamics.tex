...
\begin{equation}
    \dot{\boldsymbol{\nu} _P} = \frac{\partial}{\partial t} \begin{bmatrix}
        \mathbf{v} _P (t) \\
        \boldsymbol{\omega} _P (t)
...
\paragraph{Spatial Forces} The spatial force acting on a rigid body is defined as:
...
The equation of motion of a generic multibody system can be derived starting from the second Newton's law of motion generalized to a system of $N _B$ particles:
...
\begin{equation}
    \ddot{\mathbf{q}} = \mathrm{FD} (model, \mathbf{q}, \dot{\mathbf{q}}, \boldsymbol{\tau})
\end{equation}
...
\begin{figure}[h]
    ...
    \subfloat[Branched kinematic tree]{
        ...
        \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
            ...
            \path  [shading=_hbtcw454n,_pm47npqyx] (520.88,186.7) .. controls (514.23,191.8) and (494.33,176.98) .. (476.44,153.61) .. controls (458.55,130.24) and (449.43,107.17) .. (456.09,102.08) .. controls (462.74,96.98) and (482.63,111.8) .. (500.53,135.17) .. controls (518.42,158.54) and (527.53,181.61) .. (520.88,186.7) -- cycle ;
    ...
    \subfloat[Kinematic subtree division.]{
        ...
        \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
            ...
            \path  [shading=_pe1dgwonr,_3yz7x95el] (561.88,238.7) .. controls (555.23,243.8) and (535.33,228.98) .. (517.44,205.61) .. controls (499.55,182.24) and (490.43,159.17) .. (497.09,154.08) .. controls (503.74,148.98) and (523.63,163.8) .. (541.53,187.17) .. controls (559.42,210.54) and (568.53,233.61) .. (561.88,238.7) -- cycle ;
...
By diving the kinematic structure in sub-trees as shown in \cref{fig:kin_tree}, i.e. starting from the leaves and going up to the root, by considering a joint $i$ interacting with the rest of the kinematic chain through an unknown force $\mathbf{f} _i$ defined as:
...
\begin{figure}
    ...
    \subfloat[Uncostrained System]{
        ...
        \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
            ...
            \path  [shading=_pokbkkxvx,_gxyzl2ql8] (317.12,126.9) .. controls (322.47,132.3) and (313.09,153.79) .. (296.17,174.89) .. controls (279.26,195.98) and (261.21,208.71) .. (255.86,203.31) .. controls (250.52,197.9) and (259.89,176.42) .. (276.81,155.32) .. controls (293.72,134.22) and (311.77,121.5) .. (317.12,126.9) -- cycle ;
