...
\begin{equation}
    ...
    \end{bmatrix} \qquad \rightarrow \qquad {}^A\mathbf{p} = {}^A \mathbf{H}_F {}^F \mathbf{p}
\end{equation}
...
\begin{align}
    ...
    {}^B\omega_{A,B} &= \left({}^B\mathbf{R}_B^\top {}^A\dot{\mathbf{R}}_B \right)^\vee \nonumber 
\end{align}
