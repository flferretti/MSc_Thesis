...
In \ac{DRL} the policy is described by a Neural Network (\ac{NN}), therefore it is modelled as a probability distribution parametrized by the set of the \ac{NN} parameters $\boldsymbol{\theta}$ as:
