...
The \ac{RL} framework has been trained for $10$M steps, which given the episodic length, corresponds to $1024$ epochs. The training took approximately $90$ minutes on the \texttt{IITBMP014SRV001} machine thanks to the high number of available cores.
