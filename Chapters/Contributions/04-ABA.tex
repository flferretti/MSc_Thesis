...
\begin{equation}
    \begin{bmatrix}
        ...
        \mathbb{M} _{\mathcal{B}S} ^T(q) & \mathbb{M} _s(q)
    \end{bmatrix}
    \begin{bmatrix}
        \dot{\mathrm{\mathbf{v}}} \\
        \ddot{\mathbf{s}}
...
\begin{equation}
    \underbrace{\begin{bmatrix}
            \mathbb{M} _{\mathcal{B}}(q)     & \mathbb{M} _{\mathcal{B}S}(q)                                                      \\
            \mathbb{M} _{\mathcal{B}S} ^T(q) & \mathbb{M} _s(q) + \boldsymbol{\Gamma} ^{-T}\mathbb{M} ^M\boldsymbol{\Gamma} ^{-1}
...
In a more compact compact form, the \ac{EoM} can be rewritten as:
...
\begin{equation}
    \dot{\boldsymbol{\nu}} = \mathbf{\bar{M}}(q) ^{-1} (\mathbf{\bar{B}}\boldsymbol{\tau} _m + \mathbf{J} ^T \mathbf{f} - \mathbf{h}(q,\boldsymbol{\nu}) - \bar{\mathbf{K _v}}\boldsymbol{\nu})
\end{equation}
...
\begin{equation}
    \mathbf{a} ^{uncostrained} _{R _i} = (\mathbb{M} ^M _i) ^{-1}(\boldsymbol{\Phi} _i \frac{\boldsymbol{\tau} _i}{\boldsymbol{\Gamma} _i} - \mathbf{p} ^M _i)
\end{equation}

where $\mathbb{M} ^M _i$ is the inertia of the rotor, $\mathbf{p} ^M _i$ is the bias force of the rotor defined as $\mathbf{p} ^M _i = {} ^M \mathbf{v} _i\times ^* \mathbb{M} ^M _i {} ^M \mathbf{v} _i$, where ${} ^M \mathbf{v} = \mathbf{v} _{\lambda (i)} + {} ^M \boldsymbol{\Phi} _i \dot{\mathbf{s}} _i$ and $\boldsymbol{\Gamma} _i$ is the gear ratio.
...
\begin{equation}
    \begin{aligned}
         ...
         &                                               & \sum _{i \in \mathbb{L}} (\mathbf{a}_i - \mathbf{a} _i ^{\text{uc} }) ^T \mathbb{M}_i(\mathbf{a}_i - \mathbf{a} ^{\text{uc}} _i) \\
         & \text{subject to}
...
\begin{equation}
    J = \mathbf{a} ^T _i \mathbb{M} ^A _i \mathbf{a} _i - 2\mathbf{a} ^T _i \mathbb{M} ^a _i \mathbf{a} ^{uc} _i + (\mathbf{a} ^{uc} _i) ^T \mathbb{M} ^a _i \mathbf{a} ^{uc} _i + {} ^M \mathbf{a} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{a} _i - 2 {} ^M \mathbf{a} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{a} ^{uc} _i + ({} ^M \mathbf{a} ^{uc} _i) ^T \mathbb{M} ^M _i {} ^M \mathbf{a} ^{uc} _i
\end{equation}

as any term that is not quadratic in $\ddot{\mathbf{s}}$ is zero. The objective function can be then rewritten as:

\begin{equation}
    J _1 = \mathbf{a} ^T _i \mathbb{M} ^A _i \mathbf{a} _i - 2\mathbf{a} ^T _i \mathbb{M} ^a _i \mathbf{a} ^{uc} _i
\end{equation}

and

\begin{equation}
    J _2 = {} ^M \mathbf{a} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{a} _i - 2 {} ^M \mathbf{a} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{a} ^{uc} _i
\end{equation}
...
\begin{align}
    \frac{\partial J _1}{\partial \ddot{\mathbf{s}} _i} & = 2 \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \boldsymbol{\Phi} _i \ddot{\mathbf{s}} _i + 2 \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i (\mathbf{a} _{\lambda (i)} + \mathbf{c} _i) - 2 \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \mathbf{a} ^{uc} _i \nonumber                                        \\
    \frac{\partial J _2}{\partial \ddot{\mathbf{s}} _i} & = 2 {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i {} ^M \boldsymbol{\Phi} _i \ddot{\mathbf{s}} _i + 2 {} ^M  \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i (\mathbf{a} _{\lambda (i)} + {} ^M  \mathbf{c} _i) - 2 {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{a} ^{uc} _i  \nonumber
\end{align}

Adding up the two terms and defining for compactness:

\begin{equation}
    \mathbf{D} _i = \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \boldsymbol{\Phi} _i + {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i {} ^M \boldsymbol{\Phi} _i
\end{equation}

we get to:

\begin{equation}
    \ddot{\mathbf{s}} _i = \mathbf{D} _i ^{-1} (\boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i (\mathbf{a} _{\lambda (i)} + \mathbf{c} _i - \mathbf{a} ^{uc} _i) + {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i ( \mathbf{a} _{\lambda (i)} + {} ^M \mathbf{c} _i - {} ^M \mathbf{a} ^{uc} _i))
\end{equation}
...
\begin{align}
    \mathbf{D} _i = \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \boldsymbol{\Phi} _i + {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i {} ^M \boldsymbol{\Phi} _i & \qquad \mathbf{c} _i = (\mathbf{v} _i \times) \boldsymbol{\Phi} _i \dot{\mathbf{s}} _i & \qquad \mathbf{c} _i ^M = ({} ^M \mathbf{v} _i \times) {} ^M \boldsymbol{\Phi} _i \dot{\mathbf{s}} _i
\end{align}
...
\begin{align}
    \mathbb{M} _i ^A \mathbf{a} _i = \mathbb{M} _i ^A (\mathbf{a} _{\lambda (i)} - \boldsymbol{\Phi} _i \ddot{\mathbf{s}} + \mathbf{c}_i) & \qquad \mathbb{M} _i ^M \mathbf{a} _i ^M = \mathbb{M} _i ^M (\mathbf{a} _{\lambda (i)} - {} ^M \boldsymbol{\Phi} _i \ddot{\mathbf{s}} + {} ^M \mathbf{c}_i)
\end{align}

which can be substituted in the equation above to obtain:

\begin{equation}
    \mathbb{M} _{\lambda(i)} ^A \mathbf{p} _{\lambda(i)} ^A = \mathbb{M} _{\lambda (i)} \mathbf{a} _{\lambda (i)} + \mathbf{p} _{\lambda (i)} + \mathbb{M} _i ^A (\mathbf{a} _{\lambda (i)} - \boldsymbol{\Phi} _i \ddot{\mathbf{s}} + \mathbf{c}_i) + \mathbf{p} _i ^A + \mathbb{M} _i ^M (\mathbf{a} _{\lambda (i)} - {} ^M \boldsymbol{\Phi} _i \ddot{\mathbf{s}} + {} ^M \mathbf{c}_i) + \mathbf{p} _i ^M
\end{equation}

and

\begin{equation}
    \mathbf{p} ^A = \mathbf{p} ^A _{\lambda (i)} + {}^i\mathbf{X} _{\lambda (i)} ^T (\mathbf{p} ^A_i + \mathbf{p} ^M_i  + \mathbb{M} ^A _{\lambda (i)}  \mathbf{c}_i + \mathbb{M} {} ^M _i \mathbf{c} ^M _i + {}  \mathbf{U} _i \mathbf{D} ^{-1} _i {} \mathbf{u} _i + {} ^M \mathbf{U} _i \mathbf{D} ^{-1} _i {} ^M\mathbf{u} _i)
\end{equation}

% \mathbf{p} _{\lambda (i)} ^A = \mathbf{p} _{\lambda (i)} + \mathbf{p} _i ^A + \mathbf{p} _i ^M + \mathbb{M} _i ^A \mathbf{c} _i + \mathbb{M} _i ^M {} ^M \mathbf{c} _i + \mathbb{M} _i ^A \boldsymbol{\Phi} _i \mathbf{D} _i ^{-1} \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \mathbf{a} _i ^{uc} - \mathbb{M} _i ^A \boldsymbol{\Phi} _i \mathbf{D} ^{-1} _i \boldsymbol{\Phi} ^T _i \mathbb{M} ^A _i \mathbf{c} _i + \mathbb{M} _i ^M \boldsymbol{\Phi} _i ^M \mathbf{D} _i ^{-1} {}^M \boldsymbol{\Phi} _i ^T \mathbb{M} ^M _i {} ^M \mathbf{a} _i ^{uc} - \mathbb{M} _i ^M \boldsymbol{\Phi} _i ^M \mathbf{D} ^{-1} _i {} ^M \boldsymbol{\Phi} ^T _i \mathbb{M} ^M _i {} ^M \mathbf{c} _i
...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \If{$\lambda_i \neq 0$}
        \State $\mathbb{M} ^A = \mathbb{M} ^A _{\lambda (i)} + {}^i\mathbf{X} _{\lambda (i)} ^T (\mathbb{M} _i ^A + \textcolor{webgreen}{\mathbb{M} _i ^M } - {}  \mathbf{U} _i  \mathbf{D} ^{-1} _i  {}  \mathbf{U} ^T _i \textcolor{webgreen}{- {} ^M \mathbf{U} _i  \mathbf{D} ^{-1} _i {} ^M \mathbf{U} ^T _i}) {} ^i \mathbf{X} _{\lambda (i)} $
        \State $\mathbf{p} ^A = \mathbf{p} ^A _{\lambda (i)} + {}^i\mathbf{X} _{\lambda (i)} ^T (\mathbf{p} ^A_i + \textcolor{webgreen}{\mathbf{p} ^M_i } + \mathbb{M} ^A _{\lambda (i)}  \mathbf{c}_i + \textcolor{webgreen}{\mathbb{M} {} ^M _i \mathbf{c} ^M _i }+ {}  \mathbf{U} _i \mathbf{D} ^{-1} _i {} \mathbf{u} _i + \textcolor{webgreen}{{} ^M \mathbf{U} _i \mathbf{D} ^{-1} _i {} ^M\mathbf{u} _i}) $
        \EndIf
        \EndFor
        ...
        \State $\ddot{\mathbf{s}}_i = \mathbf{D}^{-1} (\mathbf{u}_i \textcolor{webgreen}{+ {}^M\mathbf{u}_i }- (\mathbf{U}_i^T + \textcolor{webgreen}{{}^M\mathbf{U}_i^T})\mathbf{a}')$
