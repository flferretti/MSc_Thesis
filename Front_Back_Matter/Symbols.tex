...
\nomenclature[ROB]{$\mathfrak{se}(3)$}{Lie Algebra of $SO3$}
\nomenclature[ROB]{$\mathfrak{so}(3)$}{Lie Algebra of $SO3$}
...
\nomenclature[ROB]{${}^Bv_A \in \mathbb{R}^3$}{Velocity Vector from A to B, measured in B}
\nomenclature[ROB]{${}^B\omega_A \in \mathbb{R}^3$}{Angular Velocity Vector from A to B, measured in B}
